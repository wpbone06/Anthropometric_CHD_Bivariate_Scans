...
###############################################################################
#These edits need to be after the selection of independent SNP so ignore these commented out lines
###############################################################################

#calculate mean of out data z-scores
#harZoutMean = mean(har$z_out)

# calculated variance and SE
#harZoutVar = var(har$z_out)
#harZoutSE = sqrt(harZoutVar)

# perform standardizing transformation
#harZstnd = (har$z_out - harZoutMean) / harZoutSE
...
###############################################################################
#These edits are designed to transform the har$z_out column to make it standard normal. This is required to generate a variance of 1 for several anthropomorphic traits that seem to be overly genomic corrected
###############################################################################
...
# perform standardizing transformation
harZstnd = (res$z_out - harZoutMean) / harZoutSE
